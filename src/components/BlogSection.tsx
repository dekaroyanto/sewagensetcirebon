    ...
    <section id="blog" className="py-16 sm:py-20 bg-white relative">
      ...
      {activeArticle && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 backdrop-blur-xs flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
          <div
            className="relative bg-white rounded-2xl max-w-3xl w-full overflow-hidden shadow-2xl border border-slate-200 max-h-[90vh] flex flex-col my-auto"
          ...
          >
            ...
            {/* Modal Content */}
            <div className="p-6 sm:p-8 overflow-y-auto flex-1 overscroll-contain space-y-5">
            ...
            {/* Modal Footer */}
            <div className="p-4 sm:p-6 border-t border-slate-200 bg-slate-50 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
              <button
